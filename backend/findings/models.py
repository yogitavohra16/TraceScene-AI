...
class Finding(models.Model):
    ...
    case = models.OneToOneField("cases.Case", on_delete=models.CASCADE, related_name="finding")
    hypothesis = models.TextField()
    confidence_score = models.FloatField(default=0)
    supporting_evidence_ids = models.JSONField(default=list, blank=True)
    status = models.CharField(max_length=20, choices=FindingStatus.choices, default=FindingStatus.PROPOSED)
