...
class CaseEvidenceListView(ListAPIView):
    ...
    def get_queryset(self):
        return Evidence.objects.filter(case_id=self.kwargs["case_id"]).order_by("-correlation_score")
...
class EvidenceDetailView(RetrieveUpdateAPIView):
    ...
    def get_serializer_class(self):
        return EvidenceUpdateSerializer if self.request.method == "PATCH" else EvidenceSerializer
